...
class QrTransferConfirmationPage extends StatelessWidget {
  final String recipientName;
  final String recipientMobile;
  final double amount;
  final String transactionDetail;

  const QrTransferConfirmationPage({
    super.key,
  ...
  Future<void> _confirmTransfer(BuildContext context) async {
    ...
    final response = await TransferApiService().qrTransfer(transferRequest);
